     ...
     // console.log(res.code);
      ...
      wx.request({
        ...
        success: function(res) {
          ...
          wx.request({
            url:'https://vircom.top/api/getcoupon.php',//改成你自己的链接
            header:{
            'Content-Type':'application/x-www-form-urlencoded'
            },
            data:{
            ...
            success:function(res){
           //console.log(res.data)
app.globalData.coupon=res.data;
...
wx.request({
  url: 'https://vircom.top/api/getcoupon.php',
  data: {
...
console.log(res.data.code != 0 || res.data.data.length == 0)
